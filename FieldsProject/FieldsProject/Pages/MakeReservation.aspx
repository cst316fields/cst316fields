        ...
        <tr>
            ...
            <td class="container_content">
                ...
                <div class="make_reservation_container">
                    ...
                    <asp:Calendar ID="calendarMakeRes" runat="server" OnSelectionChanged="Calendar1_SelectionChanged" BorderColor="#5D7B9D" BorderStyle="Solid" BorderWidth="5px" ForeColor="#333333" BackColor="White">
